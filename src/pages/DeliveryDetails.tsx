      ...
      <div className="px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-8 px-4">
          <div className="flex flex-col items-center gap-2">
             ...
             <span className="text-[9px] font-black text-[#006644] uppercase tracking-tighter">Prescription</span>
          </div>
        ...
        <div className="bg-[#E6F0ED] rounded-[24px] p-5 flex items-start gap-4 mb-8 border border-green-100">
           ...
           <div className="flex-1">
              <h4 className="text-[14px] font-black text-[#006644] mb-1">Prescription Approved</h4>
              <p className="text-[11px] text-[#4B5563] font-medium leading-relaxed">
                 Your order #RD-8921 for <span className="font-bold">Amoxicillin 500mg</span> has been verified by our pharmacist.
              </p>
              <div className="flex gap-6 mt-3">
                 <div>
                    <p className="text-[9px] font-black text-[#6B7280] uppercase tracking-tighter">Item Price</p>
                    <p className="text-[12px] font-black text-[#006644]">450.00 ETB</p>
                 </div>
                 <div>
                    <p className="text-[9px] font-black text-[#6B7280] uppercase tracking-tighter">Est. Delivery</p>
                    <p className="text-[12px] font-black text-[#004A8F]">85.00 ETB</p>
                 </div>
              </div>
           </div>
        </div>
        ...
        <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-50 mb-10">
           ...
           <div className="space-y-6">
              <div>
                 <label className="text-[11px] font-black text-[#111827] uppercase tracking-widest block mb-2 px-1">Sub-City</label>
                 <select className="w-full bg-[#F3F4F6] border-none rounded-[16px] px-6 py-4 text-[14px] font-medium focus:ring-2 focus:ring-[#004A8F] transition-all appearance-none">
              ...
              <div className="flex items-center justify-between p-4 bg-[#F3F4F6] rounded-[20px]">
                 <div className="flex items-center gap-3">
                    <span className="material-symbols-outlined text-[#6B7280]">bookmark</span>
                    <span className="text-[12px] font-bold text-[#4B5563]">Save this address for future orders</span>
                 </div>
                 <label className="relative inline-flex items-center cursor-pointer">
                   <input type="checkbox" className="sr-only peer" />
                   <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#004A8F]"></div>
                 </label>
              </div>
           </div>
        </div>
        ...
        <div className="bg-[#F3F4F6]/80 backdrop-blur-md rounded-[32px] p-6 border border-gray-100 shadow-lg">
           <div className="flex justify-between items-center mb-6 px-2">
              <span className="text-[14px] font-black text-[#6B7280] uppercase tracking-widest">Estimated Total</span>
              <div className="flex items-baseline gap-1">
                 <span className="text-[24px] font-black text-[#004A8F]">535.00</span>
           ...
           <p className="text-[10px] text-[#6B7280] text-center mt-4 px-8 leading-relaxed font-medium">
             Your medical data and delivery details are encrypted and secure.
           </p>
        </div>
      </div>
